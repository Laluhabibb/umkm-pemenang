...
if ($cek > 0) {
    ...
    if ($data['jenis'] == "admin") {
        if ($password == $data['password']) {
            ...
            header("Location: https://umkm-pemenang.onrender.com/.admin/index.php?pesan=berhasil"); // Redirect ke dashboard admin
            exit;
        } else {
            // Password salah
    ...
    if (password_verify($password, $data['password'])) {
        if ($data['status'] == "aktif") {
            ...
            header("Location: https://umkm-pemenang.onrender.com/.member/index.php?pesan=berhasil"); // Redirect ke dashboard member
            exit;
        } else {
